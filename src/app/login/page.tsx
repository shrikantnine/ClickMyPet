        ...
        <div className="bg-white/20 backdrop-blur-lg rounded-2xl border border-white/30 p-8 shadow-xl">
          ...
          <div className="text-center mb-8">
            <Link href="/" className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="font-bold text-2xl text-gray-900">Click My Pet</span>
            </Link>
            ...
            <p className="text-gray-800">
              {isSignUp 
                ? 'Start creating amazing AI pet photos' 
                : 'Sign in to access your pet photo gallery'
              }
            </p>
          </div>
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="w-full mb-6 bg-white hover:bg-gray-50 border-gray-300"
          >
